...
local normal_mappings = {
  ...
  ["d"] = { "<cmd>bprevious | bdelete #<CR>", "Close Buffer" },
  ["D"] = { "<cmd>bdelete!<CR>", "Force Close Buffer" },
  ["h"] = { "<C-w>s" },
  ["g"] = { "<C-W>v" },
  ["x"] = { ":close<CR>" },
  ["f"] = { "<cmd>Telescope live_grep theme=ivy<cr>", "Find Text" },
  ["p"] = { "<cmd>lua require('telescope.builtin').find_files(require('telescope.themes').get_dropdown{previewer = false})<cr>", "Find files", },
  ["P"] = { "<cmd>lua require('telescope').extensions.projects.projects()<cr>", "Projects" },
  ["/"] = { "<Cmd>lua require('Comment.api').call('toggle_current_linewise_op')<CR>g@$", "Comment"},
  ["w"] = { "<cmd>write<CR>", "Write" },
  ["q"] = { "<cmd>quit<CR>", "Close" },
  ["Q"] = { "<cmd>quitall!<CR>", "Force Quit" },
  -- [" "] = { "", "Close this" },
